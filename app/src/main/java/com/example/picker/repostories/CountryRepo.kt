package com.kursat.countrycodepicker.repostories

import com.kursat.countrycodepicker.models.Country

class CountryRepo {
    fun allCountries(): ArrayList<Country>{
        ...
        countries.add(Country("ax", "358", "Aland Islands"))
        countries.add(Country("az", "994", "Azerbaijan"))
        countries.add(Country("ba","387","Bosnia"))
        ...
        countries.add(Country("bl", "590", "Saint Barthelemy"))
        countries.add(Country("bm", "1", "Bermuda"))
        countries.add(Country("bn", "673", "Brunei"))
        countries.add(Country("bo","591","Bolivia"))
        ...
        //countries.add(Country("cc","61","Cocos Islands"))
        countries.add(Country("cd","243","Democratic Republic Of The Congo"))
        countries.add(Country("cf","236","Central African Republic"))
        countries.add(Country("cg", "242", "Republic Of The Congo"))
        countries.add(Country("ch", "41", "Switzerland"))
        countries.add(Country("ci", "225", "Cote Divoire"))
        ...
        countries.add(Country("cw", "599", "Curacao"))
        ...
        countries.add(Country("fk","500","Falkland Islands"))
        countries.add(Country("fm","691","Micronesia"))
        ...
        countries.add(Country("im", "44", "Isleof Man"))
        ...
        countries.add(Country("ir","98","Iran"))
        ...
        countries.add(Country("la", "856", "Laos"))
        ...
        countries.add(Country("md", "373", "Moldova"))
        ...
        countries.add(Country("mk", "389", "Macedonia"))
        ...
        countries.add(Country("nf", "672", "Norfolk Island"))
        ...
        countries.add(Country("pm","508","Saint Pierre"))
        ...
        countries.add(Country("re", "262", "Soviet Union"))
        ...
        countries.add(Country("sh","290","Saint Helena"))
        ...
        countries.add(Country("sy", "963", "Syria"))
        ...
        countries.add(Country("tt", "1", "Trinidad and Tobago"))
        countries.add(Country("tv", "688", "Tuvalu"))
        countries.add(Country("tw", "886", "Taiwan"))
        countries.add(Country("tz","255","Tanzania"))
        countries.add(Country("ua", "380", "Ukraine"))
        countries.add(Country("ug", "256", "Uganda"))
        countries.add(Country("us", "1", "United States Of America"))
        countries.add(Country("uy", "598", "Uruguay"))
        countries.add(Country("uz", "998", "Uzbekistan"))
        countries.add(Country("va","379","Vatican City"))
        countries.add(Country("vc","1","Saint Vicent and The Grenadines"))
